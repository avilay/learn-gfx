...
// include: /tmp/tmpp3xz8w2y.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web-cpp.data';
      var REMOTE_PACKAGE_BASE = 'web-cpp.data';
...
Module['FS_createPath']("/home", "avilay", true, true);
Module['FS_createPath']("/home/avilay", "projects", true, true);
Module['FS_createPath']("/home/avilay/projects", "bitbucket", true, true);
Module['FS_createPath']("/home/avilay/projects/bitbucket", "learn", true, true);
Module['FS_createPath']("/home/avilay/projects/bitbucket/learn", "learn-gfx", true, true);
Module['FS_createPath']("/home/avilay/projects/bitbucket/learn/learn-gfx", "learn-raylib", true, true);
Module['FS_createPath']("/home/avilay/projects/bitbucket/learn/learn-gfx/learn-raylib", "web-cpp", true, true);
Module['FS_createPath']("/home/avilay/projects/bitbucket/learn/learn-gfx/learn-raylib/web-cpp", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web-cpp.data');

      };
      Module['addRunDependency']('datafile_web-cpp.data');
    ...
    loadPackage({"files": [{"filename": "/home/avilay/projects/bitbucket/learn/learn-gfx/learn-raylib/web-cpp/resources/cyberpunk_street_background.png", "start": 0, "end": 7735}, {"filename": "/home/avilay/projects/bitbucket/learn/learn-gfx/learn-raylib/web-cpp/resources/cyberpunk_street_foreground.png", "start": 7735, "end": 25770}, {"filename": "/home/avilay/projects/bitbucket/learn/learn-gfx/learn-raylib/web-cpp/resources/cyberpunk_street_midground.png", "start": 25770, "end": 33572}], "remote_package_size": 33572});

  })();

// end include: /tmp/tmpp3xz8w2y.js
// include: /tmp/tmpt3hw4iat.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpt3hw4iat.js
// include: /tmp/tmpv5h0ejpb.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpv5h0ejpb.js
...
var ASM_CONSTS = {
  98116: () => { if (document.fullscreenElement) return 1; },  
 98162: () => { return document.getElementById('canvas').width; },  
 98214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98282: () => { document.exitFullscreen(); },  
 98309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98382: () => { if (document.fullscreenElement) return 1; },  
 98428: () => { return document.getElementById('canvas').width; },  
 98480: () => { return screen.width; },  
 98505: () => { document.exitFullscreen(); },  
 98532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98665: () => { return window.innerWidth; },  
 98691: () => { return window.innerHeight; },  
 98718: () => { if (document.fullscreenElement) return 1; },  
 98764: () => { return document.getElementById('canvas').width; },  
 98816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98884: () => { if (document.fullscreenElement) return 1; },  
 98930: () => { return document.getElementById('canvas').width; },  
 98982: () => { return screen.width; },  
 99007: () => { return window.innerWidth; },  
 99033: () => { return window.innerHeight; },  
 99060: () => { if (document.fullscreenElement) return 1; },  
 99106: () => { return document.getElementById('canvas').width; },  
 99158: () => { return screen.width; },  
 99183: () => { document.exitFullscreen(); },  
 99210: () => { if (document.fullscreenElement) return 1; },  
 99256: () => { return document.getElementById('canvas').width; },  
 99308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99376: () => { document.exitFullscreen(); },  
 99403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99461: () => { return screen.width; },  
 99486: () => { return screen.height; },  
 99512: () => { return window.screenX; },  
 99539: () => { return window.screenY; },  
 99566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100074: () => { if (document.fullscreenElement) return 1; },  
 100120: () => { return window.innerWidth; },  
 100146: () => { return window.innerHeight; },  
 100173: () => { if (document.pointerLockElement) return 1; }
};
